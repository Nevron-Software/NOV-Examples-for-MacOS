...
Namespace Nevron.Nov.Examples.Text
	...
	Public Class NBlockAppearanceExample
		...
		''' </summary>
		Shared Sub New()
            Nevron.Nov.Examples.Text.NBlockAppearanceExample.NBlockAppearanceExampleSchema = Nevron.Nov.Dom.NSchema.Create(GetType(Nevron.Nov.Examples.Text.NBlockAppearanceExample), NExampleBaseSchema)
        End Sub
...
"
        ...
        Private Sub PopulateRichText()
            ...
            section.Blocks.Add(Nevron.Nov.Examples.Text.NBlockAppearanceExample.GetDescriptionBlock("Block Appearance", "Every block in the document follows the HTML block formatting model which allows you to specify filling and border. The following paragraph has gradient background filling and solid border.", 1))
            Dim paragraph As Nevron.Nov.Text.NParagraph = New Nevron.Nov.Text.NParagraph()
            Dim textInline As Nevron.Nov.Text.NTextInline = New Nevron.Nov.Text.NTextInline("Paragraph with a solid border and gradient filling applied on the background.")
            textInline.Fill = New Nevron.Nov.Graphics.NColorFill(Nevron.Nov.Graphics.NColor.Aquamarine)
            textInline.FontSize = 24
            paragraph.Inlines.Add(textInline)
            paragraph.BackgroundFill = New Nevron.Nov.Graphics.NStockGradientFill(Nevron.Nov.Graphics.ENGradientStyle.FromCorner, Nevron.Nov.Graphics.ENGradientVariant.Variant1, Nevron.Nov.Graphics.NColor.Gainsboro, Nevron.Nov.Graphics.NColor.SlateGray)
            paragraph.Border = Nevron.Nov.UI.NBorder.CreateFilledBorder(Nevron.Nov.Graphics.NColor.DarkBlue)
            paragraph.BorderThickness = New Nevron.Nov.Graphics.NMargins(3)
            paragraph.PreferredWidth = New Nevron.Nov.NMultiLength(Nevron.Nov.ENMultiLengthUnit.Dip, 500)
		...
		Public Shared ReadOnly NBlockAppearanceExampleSchema As Nevron.Nov.Dom.NSchema
        ...
        Private Shared Function GetDescriptionBlock(ByVal title As String, ByVal description As String, ByVal level As Integer) As Nevron.Nov.Text.NGroupBlock
            ...
            Dim paragraph As Nevron.Nov.Text.NParagraph = Nevron.Nov.Examples.Text.NBlockAppearanceExample.GetTitleParagraphNoBorder(title, level)
            ...
            groupBlock.Blocks.Add(Nevron.Nov.Examples.Text.NBlockAppearanceExample.GetDescriptionParagraph(description))
            groupBlock.Border = Nevron.Nov.Examples.Text.NBlockAppearanceExample.CreateLeftTagBorder(color)
            groupBlock.BorderThickness = Nevron.Nov.Examples.Text.NBlockAppearanceExample.defaultBorderThickness
            Return groupBlock
        End Function
		''' <summary>
