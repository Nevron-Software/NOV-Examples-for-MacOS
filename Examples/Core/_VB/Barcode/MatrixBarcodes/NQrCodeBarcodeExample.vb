...
Namespace Nevron.Nov.Examples.Barcode
    Public Class NQrCodeBarcodeExample
		...
		''' </summary>
		Shared Sub New()
            Nevron.Nov.Examples.Barcode.NQrCodeBarcodeExample.NQrCodeBarcodeExampleSchema = Nevron.Nov.Dom.NSchema.Create(GetType(Nevron.Nov.Examples.Barcode.NQrCodeBarcodeExample), NExampleBase.NExampleBaseSchema)
        End Sub
		...
		Protected Overrides Function CreateExampleContent() As Nevron.Nov.UI.NWidget
            ...
            Me.m_Barcode.Symbology = Nevron.Nov.Barcode.ENMatrixBarcodeSymbology.QrCode
...
"
		...
		''' </summary>
		Public Shared ReadOnly NQrCodeBarcodeExampleSchema As Nevron.Nov.Dom.NSchema
