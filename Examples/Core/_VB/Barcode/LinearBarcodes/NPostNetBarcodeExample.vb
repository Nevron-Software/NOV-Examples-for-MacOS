...
Namespace Nevron.Nov.Examples.Barcode
    Public Class NPostNetBarcodeExample
		...
		''' </summary>
		Shared Sub New()
            Nevron.Nov.Examples.Barcode.NPostNetBarcodeExample.NPostNetBarcodeExampleSchema = Nevron.Nov.Dom.NSchema.Create(GetType(Nevron.Nov.Examples.Barcode.NPostNetBarcodeExample), NExampleBase.NExampleBaseSchema)
        End Sub
		...
		Protected Overrides Function CreateExampleContent() As Nevron.Nov.UI.NWidget
            ...
            Me.m_Barcode.Symbology = Nevron.Nov.Barcode.ENLinearBarcodeSymbology.PostNet
            Me.m_Barcode.Text = "555551237"
...
"
		...
		''' </summary>
		Public Shared ReadOnly NPostNetBarcodeExampleSchema As Nevron.Nov.Dom.NSchema
