...
Namespace Nevron.Nov.Examples.Barcode
    Public Class NCode11BarcodeExample
		...
		''' </summary>
		Shared Sub New()
            Nevron.Nov.Examples.Barcode.NCode11BarcodeExample.NCode11BarcodeExampleSchema = Nevron.Nov.Dom.NSchema.Create(GetType(Nevron.Nov.Examples.Barcode.NCode11BarcodeExample), NExampleBase.NExampleBaseSchema)
        End Sub
		...
		Protected Overrides Function CreateExampleContent() As Nevron.Nov.UI.NWidget
            ...
            Me.m_Barcode.Symbology = Nevron.Nov.Barcode.ENLinearBarcodeSymbology.Code11
            Me.m_Barcode.Text = "012345"
...
"
		...
		''' </summary>
		Public Shared ReadOnly NCode11BarcodeExampleSchema As Nevron.Nov.Dom.NSchema
