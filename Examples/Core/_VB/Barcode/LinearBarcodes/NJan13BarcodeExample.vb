...
Namespace Nevron.Nov.Examples.Barcode
    Public Class NJan13BarcodeExample
		...
		''' </summary>
		Shared Sub New()
            Nevron.Nov.Examples.Barcode.NJan13BarcodeExample.NJan13BarcodeExampleSchema = Nevron.Nov.Dom.NSchema.Create(GetType(Nevron.Nov.Examples.Barcode.NJan13BarcodeExample), NExampleBase.NExampleBaseSchema)
        End Sub
		...
		Protected Overrides Function CreateExampleContent() As Nevron.Nov.UI.NWidget
            ...
            Me.m_Barcode.Symbology = Nevron.Nov.Barcode.ENLinearBarcodeSymbology.JAN13
            Me.m_Barcode.Text = "4912345678904"
...
"
		...
		''' </summary>
		Public Shared ReadOnly NJan13BarcodeExampleSchema As Nevron.Nov.Dom.NSchema
