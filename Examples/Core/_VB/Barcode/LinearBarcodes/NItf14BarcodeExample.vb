...
Namespace Nevron.Nov.Examples.Barcode
    Public Class NItf14BarcodeExample
		...
		''' </summary>
		Shared Sub New()
            Nevron.Nov.Examples.Barcode.NItf14BarcodeExample.NItf14BarcodeExampleSchema = Nevron.Nov.Dom.NSchema.Create(GetType(Nevron.Nov.Examples.Barcode.NItf14BarcodeExample), NExampleBase.NExampleBaseSchema)
        End Sub
		...
		Protected Overrides Function CreateExampleContent() As Nevron.Nov.UI.NWidget
            ...
            Me.m_Barcode.Symbology = Nevron.Nov.Barcode.ENLinearBarcodeSymbology.ITF14
            Me.m_Barcode.Text = "0123456789012"
...
"
		...
		''' </summary>
		Public Shared ReadOnly NItf14BarcodeExampleSchema As Nevron.Nov.Dom.NSchema
