...
Namespace Nevron.Nov.Examples.Barcode
    Public Class NCodabarBarcodeExample
		...
		''' </summary>
		Shared Sub New()
            Nevron.Nov.Examples.Barcode.NCodabarBarcodeExample.NCodabarBarcodeExampleSchema = Nevron.Nov.Dom.NSchema.Create(GetType(Nevron.Nov.Examples.Barcode.NCodabarBarcodeExample), NExampleBase.NExampleBaseSchema)
        End Sub
		...
		Protected Overrides Function CreateExampleContent() As Nevron.Nov.UI.NWidget
            ...
            Me.m_Barcode.Symbology = Nevron.Nov.Barcode.ENLinearBarcodeSymbology.Codabar
            Me.m_Barcode.Text = "A40156B"
...
"
		...
		''' </summary>
		Public Shared ReadOnly NCodabarBarcodeExampleSchema As Nevron.Nov.Dom.NSchema
