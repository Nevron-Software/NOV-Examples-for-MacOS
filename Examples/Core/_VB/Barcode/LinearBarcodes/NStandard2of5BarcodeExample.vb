...
Namespace Nevron.Nov.Examples.Barcode
    Public Class NStandard2of5BarcodeExample
		...
		''' </summary>
		Shared Sub New()
            Nevron.Nov.Examples.Barcode.NStandard2of5BarcodeExample.NStandard2of5BarcodeExampleSchema = Nevron.Nov.Dom.NSchema.Create(GetType(Nevron.Nov.Examples.Barcode.NStandard2of5BarcodeExample), NExampleBase.NExampleBaseSchema)
        End Sub
		...
		Protected Overrides Function CreateExampleContent() As Nevron.Nov.UI.NWidget
            ...
            Me.m_Barcode.Symbology = Nevron.Nov.Barcode.ENLinearBarcodeSymbology.Standard2of5
            Me.m_Barcode.Text = "123456"
...
"
		...
		''' </summary>
		Public Shared ReadOnly NStandard2of5BarcodeExampleSchema As Nevron.Nov.Dom.NSchema
