...
Namespace Nevron.Nov.Examples.Barcode
    Public Class NInterleaved2of5BarcodeExample
		...
		''' </summary>
		Shared Sub New()
            Nevron.Nov.Examples.Barcode.NInterleaved2of5BarcodeExample.NInterleaved2of5BarcodeExampleSchema = Nevron.Nov.Dom.NSchema.Create(GetType(Nevron.Nov.Examples.Barcode.NInterleaved2of5BarcodeExample), NExampleBase.NExampleBaseSchema)
        End Sub
		...
		Protected Overrides Function CreateExampleContent() As Nevron.Nov.UI.NWidget
            ...
            Me.m_Barcode.Symbology = Nevron.Nov.Barcode.ENLinearBarcodeSymbology.Interleaved2of5
            Me.m_Barcode.Text = "01234567890"
...
"
		...
		''' </summary>
		Public Shared ReadOnly NInterleaved2of5BarcodeExampleSchema As Nevron.Nov.Dom.NSchema
