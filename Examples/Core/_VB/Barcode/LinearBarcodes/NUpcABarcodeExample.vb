...
Namespace Nevron.Nov.Examples.Barcode
    Public Class NUpcABarcodeExample
		...
		''' </summary>
		Shared Sub New()
            Nevron.Nov.Examples.Barcode.NUpcABarcodeExample.NUpcABarcodeExampleSchema = Nevron.Nov.Dom.NSchema.Create(GetType(Nevron.Nov.Examples.Barcode.NUpcABarcodeExample), NExampleBase.NExampleBaseSchema)
        End Sub
		...
		Protected Overrides Function CreateExampleContent() As Nevron.Nov.UI.NWidget
            ...
            Me.m_Barcode.Symbology = Nevron.Nov.Barcode.ENLinearBarcodeSymbology.UPCA
            Me.m_Barcode.Text = "065100004327"
...
"
		...
		''' </summary>
		Public Shared ReadOnly NUpcABarcodeExampleSchema As Nevron.Nov.Dom.NSchema
