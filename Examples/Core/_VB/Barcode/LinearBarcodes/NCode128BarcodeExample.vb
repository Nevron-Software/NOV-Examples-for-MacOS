...
Namespace Nevron.Nov.Examples.Barcode
    Public Class NCode128BarcodeExample
		...
		''' </summary>
		Shared Sub New()
            Nevron.Nov.Examples.Barcode.NCode128BarcodeExample.NCode128BarcodeExampleSchema = Nevron.Nov.Dom.NSchema.Create(GetType(Nevron.Nov.Examples.Barcode.NCode128BarcodeExample), NExampleBase.NExampleBaseSchema)
        End Sub
		...
		Protected Overrides Function CreateExampleContent() As Nevron.Nov.UI.NWidget
            ...
            Me.m_Barcode.Symbology = Nevron.Nov.Barcode.ENLinearBarcodeSymbology.Code128
            Me.m_Barcode.Text = "Nevron"
...
"
		...
		''' </summary>
		Public Shared ReadOnly NCode128BarcodeExampleSchema As Nevron.Nov.Dom.NSchema
