...
Namespace Nevron.Nov.Examples.Barcode
    Public Class NMsiMod10BarcodeExample
		...
		''' </summary>
		Shared Sub New()
            Nevron.Nov.Examples.Barcode.NMsiMod10BarcodeExample.NMsiMod10BarcodeExampleSchema = Nevron.Nov.Dom.NSchema.Create(GetType(Nevron.Nov.Examples.Barcode.NMsiMod10BarcodeExample), NExampleBase.NExampleBaseSchema)
        End Sub
		...
		Protected Overrides Function CreateExampleContent() As Nevron.Nov.UI.NWidget
            ...
            Me.m_Barcode.Symbology = Nevron.Nov.Barcode.ENLinearBarcodeSymbology.MSI_Mod10
            Me.m_Barcode.Text = "1234567"
...
"
		...
		''' </summary>
		Public Shared ReadOnly NMsiMod10BarcodeExampleSchema As Nevron.Nov.Dom.NSchema
