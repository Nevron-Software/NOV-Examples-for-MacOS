...
Namespace Nevron.Nov.Examples.Barcode
    Public Class NCode93BarcodeExample
		...
		''' </summary>
		Shared Sub New()
            Nevron.Nov.Examples.Barcode.NCode93BarcodeExample.NCode93BarcodeExampleSchema = Nevron.Nov.Dom.NSchema.Create(GetType(Nevron.Nov.Examples.Barcode.NCode93BarcodeExample), NExampleBase.NExampleBaseSchema)
        End Sub
		...
		Protected Overrides Function CreateExampleContent() As Nevron.Nov.UI.NWidget
            ...
            Me.m_Barcode.Symbology = Nevron.Nov.Barcode.ENLinearBarcodeSymbology.Code93
...
"
		...
		''' </summary>
		Public Shared ReadOnly NCode93BarcodeExampleSchema As Nevron.Nov.Dom.NSchema
