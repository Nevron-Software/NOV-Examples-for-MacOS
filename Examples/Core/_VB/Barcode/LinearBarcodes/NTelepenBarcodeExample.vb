...
Namespace Nevron.Nov.Examples.Barcode
    Public Class NTelepenBarcodeExample
		...
		''' </summary>
		Shared Sub New()
            Nevron.Nov.Examples.Barcode.NTelepenBarcodeExample.NTelepenBarcodeExampleSchema = Nevron.Nov.Dom.NSchema.Create(GetType(Nevron.Nov.Examples.Barcode.NTelepenBarcodeExample), NExampleBase.NExampleBaseSchema)
        End Sub
		...
		Protected Overrides Function CreateExampleContent() As Nevron.Nov.UI.NWidget
            ...
            Me.m_Barcode.Symbology = Nevron.Nov.Barcode.ENLinearBarcodeSymbology.Telepen
            Me.m_Barcode.Text = "Test"
...
"
		...
		''' </summary>
		Public Shared ReadOnly NTelepenBarcodeExampleSchema As Nevron.Nov.Dom.NSchema
