...
Namespace Nevron.Nov.Examples.Barcode
    Public Class NIsbnBarcodeExample
		...
		''' </summary>
		Shared Sub New()
            Nevron.Nov.Examples.Barcode.NIsbnBarcodeExample.NIsbnBarcodeExampleSchema = Nevron.Nov.Dom.NSchema.Create(GetType(Nevron.Nov.Examples.Barcode.NIsbnBarcodeExample), NExampleBase.NExampleBaseSchema)
        End Sub
		...
		Protected Overrides Function CreateExampleContent() As Nevron.Nov.UI.NWidget
            ...
            Me.m_Barcode.Symbology = Nevron.Nov.Barcode.ENLinearBarcodeSymbology.ISBN
            Me.m_Barcode.Text = "9783161484100"
...
"
		...
		''' </summary>
		Public Shared ReadOnly NIsbnBarcodeExampleSchema As Nevron.Nov.Dom.NSchema
