...
Namespace Nevron.Nov.Examples.Barcode
    Public Class NPharmacodeBarcodeExample
		...
		''' </summary>
		Shared Sub New()
            Nevron.Nov.Examples.Barcode.NPharmacodeBarcodeExample.NPharmacodeBarcodeExampleSchema = Nevron.Nov.Dom.NSchema.Create(GetType(Nevron.Nov.Examples.Barcode.NPharmacodeBarcodeExample), NExampleBase.NExampleBaseSchema)
        End Sub
		...
		Protected Overrides Function CreateExampleContent() As Nevron.Nov.UI.NWidget
            ...
            Me.m_Barcode.Symbology = Nevron.Nov.Barcode.ENLinearBarcodeSymbology.Pharmacode
...
"
		...
		''' </summary>
		Public Shared ReadOnly NPharmacodeBarcodeExampleSchema As Nevron.Nov.Dom.NSchema
