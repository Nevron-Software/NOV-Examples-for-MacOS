...
Namespace Nevron.Nov.Examples.Barcode
    Public Class NCode39BarcodeExample
		...
		''' </summary>
		Shared Sub New()
            Nevron.Nov.Examples.Barcode.NCode39BarcodeExample.NCode39BarcodeExampleSchema = Nevron.Nov.Dom.NSchema.Create(GetType(Nevron.Nov.Examples.Barcode.NCode39BarcodeExample), NExampleBase.NExampleBaseSchema)
        End Sub
		...
		Protected Overrides Function CreateExampleContent() As Nevron.Nov.UI.NWidget
            ...
            Me.m_Barcode.Symbology = Nevron.Nov.Barcode.ENLinearBarcodeSymbology.Code39
...
"
		...
		''' </summary>
		Public Shared ReadOnly NCode39BarcodeExampleSchema As Nevron.Nov.Dom.NSchema
