...
Namespace Nevron.Nov.Examples.Barcode
    Public Class NUpcEBarcodeExample
		...
		''' </summary>
		Shared Sub New()
            Nevron.Nov.Examples.Barcode.NUpcEBarcodeExample.NUpcEBarcodeExampleSchema = Nevron.Nov.Dom.NSchema.Create(GetType(Nevron.Nov.Examples.Barcode.NUpcEBarcodeExample), NExampleBase.NExampleBaseSchema)
        End Sub
		...
		Protected Overrides Function CreateExampleContent() As Nevron.Nov.UI.NWidget
            ...
            Me.m_Barcode.Symbology = Nevron.Nov.Barcode.ENLinearBarcodeSymbology.UPCE
            Me.m_Barcode.Text = "654321"
...
"
		...
		''' </summary>
		Public Shared ReadOnly NUpcEBarcodeExampleSchema As Nevron.Nov.Dom.NSchema
