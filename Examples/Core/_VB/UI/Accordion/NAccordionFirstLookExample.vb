...
Namespace Nevron.Nov.Examples.UI
    Public Class NAccordionFirstLookExample
        ...
        Shared Sub New()
            Nevron.Nov.Examples.UI.NAccordionFirstLookExample.NAccordionFirstLookExampleSchema = Nevron.Nov.Dom.NSchema.Create(GetType(Nevron.Nov.Examples.UI.NAccordionFirstLookExample), NExampleBaseSchema)
        End Sub
		...
		Protected Overrides Function CreateExampleContent() As Nevron.Nov.UI.NWidget
            ...
            Me.m_Accordion.VerticalPlacement = Nevron.Nov.Layout.ENVerticalPlacement.Top
            ...
            Me.m_Accordion.Content = stack

            ' create the sections
            stack.Add(CreateAccordionSection(NResources.Image__16x16_Mail_png, "Mail", Me.CreateMailTreeView(), False))
            stack.Add(CreateAccordionSection(NResources.Image__16x16_Calendar_png, "Calendar", Me.CreateCalendar(), True))
            stack.Add(CreateAccordionSection(NResources.Image__16x16_Contacts_png, "Contacts", Me.CreateContactsTreeView(), False))
            stack.Add(CreateAccordionSection(NResources.Image__16x16_Tasks_png, "Tasks", Me.CreateTasksView(), False))
...
"
		...
		Public Shared ReadOnly NAccordionFirstLookExampleSchema As Nevron.Nov.Dom.NSchema
