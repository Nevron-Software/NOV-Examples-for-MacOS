...
Namespace Nevron.Nov.Examples.Framework
	...
	''' </summary>
	Public Class NPaintingTextPathExample
		...
		''' </summary>
		Shared Sub New()
            Nevron.Nov.Examples.Framework.NPaintingTextPathExample.NPaintingTextPathExampleSchema = Nevron.Nov.Dom.NSchema.Create(GetType(Nevron.Nov.Examples.Framework.NPaintingTextPathExample), NExampleBase.NExampleBaseSchema)
        End Sub
...
"
		...
		Private Sub OnCanvasPrePaint(ByVal args As Nevron.Nov.UI.NCanvasPaintEventArgs)
            ...
            Dim font As Nevron.Nov.Graphics.NFont = New Nevron.Nov.Graphics.NFont(Nevron.Nov.Graphics.NFontDescriptor.DefaultSansFamilyName, 10)
            Dim path As Nevron.Nov.Graphics.NGraphicsPath = font.GetTextPath(builder.ToString(), textBounds, 96.0F, settings)
		...
		''' </summary>
		Public Shared ReadOnly NPaintingTextPathExampleSchema As Nevron.Nov.Dom.NSchema
