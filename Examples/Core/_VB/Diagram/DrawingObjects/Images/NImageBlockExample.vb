...
Namespace Nevron.Nov.Examples.Diagram
    Public Class NImageBlockExample
        ...
        ''' </summary>
        Shared Sub New()
            Nevron.Nov.Examples.Diagram.NImageBlockExample.NImageBlockExampleSchema = Nevron.Nov.Dom.NSchema.Create(GetType(Nevron.Nov.Examples.Diagram.NImageBlockExample), NExampleBaseSchema)
        End Sub
        ...
        Private Sub InitDiagram(ByVal drawingDocument As Nevron.Nov.Diagram.NDrawingDocument)
            ...
            Dim imageBlock As Nevron.Nov.Diagram.NImageBlock = shape1.ImageBlock
            imageBlock.Image = NResources.Image_FishBowl_wmf
            imageBlock.Padding = New Nevron.Nov.Graphics.NMargins(20)
		...
		Private Sub AddFormattedTextToContent(ByVal content As Nevron.Nov.Diagram.NTextBlockContent)
            content.Blocks.Add(Nevron.Nov.Examples.Diagram.NImageBlockExample.GetTitleParagraph("Bullet lists allow you to apply automatic numbering on paragraphs or groups of blocks.", 1))

			' setting bullet list template type
			If True Then
                content.Blocks.Add(Nevron.Nov.Examples.Diagram.NImageBlockExample.GetTitleParagraph("Following are bullet lists with different formatting", 2))
			...
			' nested bullet lists
			If True Then
                content.Blocks.Add(Nevron.Nov.Examples.Diagram.NImageBlockExample.GetTitleParagraph("Following is an example of bullets with different bullet level", 2))
		...
		Friend Shared Function GetTitleParagraph(ByVal text As String, ByVal level As Integer) As Nevron.Nov.Text.NParagraph
            ...
            Dim paragraph As Nevron.Nov.Text.NParagraph = Nevron.Nov.Examples.Diagram.NImageBlockExample.GetTitleParagraphNoBorder(text, level)
            paragraph.HorizontalAlignment = Nevron.Nov.Text.ENAlign.Left
            paragraph.Border = Nevron.Nov.Examples.Diagram.NImageBlockExample.CreateLeftTagBorder(color)
		...
		''' </summary>
		Public Shared ReadOnly NImageBlockExampleSchema As Nevron.Nov.Dom.NSchema
