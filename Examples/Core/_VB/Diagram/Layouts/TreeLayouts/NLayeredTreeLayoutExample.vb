...
Namespace Nevron.Nov.Examples.Diagram
    Public Class NLayeredTreeLayoutExample
        ...
        ''' </summary>
        Shared Sub New()
            Nevron.Nov.Examples.Diagram.NLayeredTreeLayoutExample.NLayeredTreeLayoutExampleSchema = Nevron.Nov.Dom.NSchema.Create(GetType(Nevron.Nov.Examples.Diagram.NLayeredTreeLayoutExample), NExampleBaseSchema)
        End Sub
...
"
        ...
        Private Sub OnRandomTree1ButtonClick(ByVal arg As Nevron.Nov.Dom.NEventArgs)
            ...
            Try
                ...
                tree.VerticesShape = Nevron.Nov.Examples.Diagram.NLayeredTreeLayoutExample.VertexShape
                tree.VerticesSize = Nevron.Nov.Examples.Diagram.NLayeredTreeLayoutExample.VertexSize
                tree.Balanced = False
        ...
        Private m_Layout As Nevron.Nov.Diagram.Layout.NLayeredTreeLayout = New Nevron.Nov.Diagram.Layout.NLayeredTreeLayout()
        ...
        ''' </summary>
        Public Shared ReadOnly NLayeredTreeLayoutExampleSchema As Nevron.Nov.Dom.NSchema
