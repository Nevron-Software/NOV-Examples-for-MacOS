...
Namespace Nevron.Nov.Examples.Diagram
    Public Class NLayeredGraphLayoutExample
		...
		''' </summary>
		Shared Sub New()
            Nevron.Nov.Examples.Diagram.NLayeredGraphLayoutExample.NLayeredGraphLayoutExampleSchema = Nevron.Nov.Dom.NSchema.Create(GetType(Nevron.Nov.Examples.Diagram.NLayeredGraphLayoutExample), NExampleBaseSchema)
        End Sub
...
<p>
    ...
    To see the layout in action on a different graph, just click the <b>Random Graph</b> button. 
        ...
        Private Sub InitDiagram(ByVal drawingDocument As Nevron.Nov.Diagram.NDrawingDocument)
            ...
            Dim shapes As Nevron.Nov.Diagram.NShape() = New Nevron.Nov.Diagram.NShape(8) {}
            Dim vertexCount As Integer = shapes.Length, edgeCount As Integer = from.Length
            Dim i, j As Integer, count As Integer = vertexCount + edgeCount

            For i = 0 To count - 1

                If i < vertexCount Then
                    j = If(vertexCount Mod 2 = 0, i, i + 1)
		...
		Private Sub OnRandomGraph1ButtonClick(ByVal arg As Nevron.Nov.Dom.NEventArgs)
            ...
            Try
                ...
                graph.EdgeCount = 15
                graph.VerticesShape = Nevron.Nov.Examples.Diagram.NLayeredGraphLayoutExample.VertexShape
                graph.VerticesSize = Nevron.Nov.Examples.Diagram.NLayeredGraphLayoutExample.VertexSize
        ...
        Private m_Layout As Nevron.Nov.Diagram.Layout.NLayeredGraphLayout = New Nevron.Nov.Diagram.Layout.NLayeredGraphLayout()
		...
		''' </summary>
		Public Shared ReadOnly NLayeredGraphLayoutExampleSchema As Nevron.Nov.Dom.NSchema
