...
Namespace Nevron.Nov.Examples.Diagram
    Public Class NRadialGraphLayoutExample
        ...
        ''' </summary>
        Shared Sub New()
            Nevron.Nov.Examples.Diagram.NRadialGraphLayoutExample.NRadialGraphLayoutExampleSchema = Nevron.Nov.Dom.NSchema.Create(GetType(Nevron.Nov.Examples.Diagram.NRadialGraphLayoutExample), NExampleBaseSchema)
        End Sub
	...
	grid and click the <b>Layout</b> button.
		...
		Private Sub OnRandomGraph1ButtonClick(ByVal arg As Nevron.Nov.Dom.NEventArgs)
            ...
            Try
                ...
                graph.EdgeCount = 15
                graph.VerticesShape = Nevron.Nov.Examples.Diagram.NRadialGraphLayoutExample.VertexShape
                graph.VerticesSize = Nevron.Nov.Examples.Diagram.NRadialGraphLayoutExample.VertexSize
        ...
        Private m_Layout As Nevron.Nov.Diagram.Layout.NRadialGraphLayout = New Nevron.Nov.Diagram.Layout.NRadialGraphLayout()
        ...
        ''' </summary>
        Public Shared ReadOnly NRadialGraphLayoutExampleSchema As Nevron.Nov.Dom.NSchema
