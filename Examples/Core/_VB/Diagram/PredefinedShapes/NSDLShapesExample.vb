...
Namespace Nevron.Nov.Examples.Diagram
    Public Class NSDLShapesExample
		...
		''' </summary>
		Shared Sub New()
            Nevron.Nov.Examples.Diagram.NSDLShapesExample.NSDLShapesExampleSchema = Nevron.Nov.Dom.NSchema.Create(GetType(Nevron.Nov.Examples.Diagram.NSDLShapesExample), NExampleBaseSchema)
        End Sub
...
"
        ...
        Private Sub InitDiagram(ByVal drawingDocument As Nevron.Nov.Diagram.NDrawingDocument)
			...
			' Create all shapes
			Dim factory As Nevron.Nov.Diagram.Shapes.NSDLDiagramShapeFactory = New Nevron.Nov.Diagram.Shapes.NSDLDiagramShapeFactory()
		...
		''' </summary>
		Public Shared ReadOnly NSDLShapesExampleSchema As Nevron.Nov.Dom.NSchema
