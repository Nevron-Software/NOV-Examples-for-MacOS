...
Namespace Nevron.Nov.Examples.Diagram
    Public Class NBusinessProcessShapesExample
		...
		''' </summary>
		Shared Sub New()
            Nevron.Nov.Examples.Diagram.NBusinessProcessShapesExample.NBusinessProcessShapesExampleSchema = Nevron.Nov.Dom.NSchema.Create(GetType(Nevron.Nov.Examples.Diagram.NBusinessProcessShapesExample), NExampleBaseSchema)
        End Sub
...
"
        ...
        Private Sub InitDiagram(ByVal drawingDocument As Nevron.Nov.Diagram.NDrawingDocument)
			...
			' create all shapes
			Dim factory As Nevron.Nov.Diagram.Shapes.NBusinessProcessShapeFactory = New Nevron.Nov.Diagram.Shapes.NBusinessProcessShapeFactory()
		...
		''' </summary>
		Public Shared ReadOnly NBusinessProcessShapesExampleSchema As Nevron.Nov.Dom.NSchema
