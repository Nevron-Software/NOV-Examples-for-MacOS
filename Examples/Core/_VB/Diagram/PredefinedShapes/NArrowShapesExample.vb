...
Namespace Nevron.Nov.Examples.Diagram
    Public Class NArrowShapesExample
		...
		''' </summary>
		Shared Sub New()
            Nevron.Nov.Examples.Diagram.NArrowShapesExample.NArrowShapesExampleSchema = Nevron.Nov.Dom.NSchema.Create(GetType(Nevron.Nov.Examples.Diagram.NArrowShapesExample), NExampleBaseSchema)
        End Sub
        ...
        Protected Overrides Function GetExampleDescription() As String
            Return "<p>This example demonstrates the arrow shapes, which are created by the NArrowShapesFactory.</p>"
        End Function
        ...
        Private Sub InitDiagram(ByVal drawingDocument As Nevron.Nov.Diagram.NDrawingDocument)
			...
			' Create all shapes
			Dim factory As Nevron.Nov.Diagram.Shapes.NArrowShapeFactory = New Nevron.Nov.Diagram.Shapes.NArrowShapeFactory()
		...
		''' </summary>
		Public Shared ReadOnly NArrowShapesExampleSchema As Nevron.Nov.Dom.NSchema
