...
Namespace Nevron.Nov.Examples.Diagram
    Public Class NBrainstormingShapesExample
		...
		''' </summary>
		Shared Sub New()
            Nevron.Nov.Examples.Diagram.NBrainstormingShapesExample.NBrainstormingShapesExampleSchema = Nevron.Nov.Dom.NSchema.Create(GetType(Nevron.Nov.Examples.Diagram.NBrainstormingShapesExample), NExampleBaseSchema)
        End Sub
        ...
        Private Sub InitDiagram(ByVal drawingDocument As Nevron.Nov.Diagram.NDrawingDocument)
			...
			' Create all shapes
			Dim factory As Nevron.Nov.Diagram.Shapes.NBrainstormingShapeFactory = New Nevron.Nov.Diagram.Shapes.NBrainstormingShapeFactory()
		...
		''' </summary>
		Public Shared ReadOnly NBrainstormingShapesExampleSchema As Nevron.Nov.Dom.NSchema
