...
Namespace Nevron.Nov.Examples.Diagram
    Public Class NGenogramShapesExample
		...
		''' </summary>
		Shared Sub New()
            Nevron.Nov.Examples.Diagram.NGenogramShapesExample.NGenogramShapesExampleSchema = Nevron.Nov.Dom.NSchema.Create(GetType(Nevron.Nov.Examples.Diagram.NGenogramShapesExample), NExampleBaseSchema)
        End Sub
...
"
        ...
        Private Sub InitDiagram(ByVal drawingDocument As Nevron.Nov.Diagram.NDrawingDocument)
			...
			' Create all shapes
			Dim factory As Nevron.Nov.Diagram.Shapes.NGenogramShapeFactory = New Nevron.Nov.Diagram.Shapes.NGenogramShapeFactory()
            ...
            While i < factory.ShapeCount
                ...
                Dim textBlock As Nevron.Nov.Diagram.NTextBlock = shape.GetFirstDescendant(Of Nevron.Nov.Diagram.NTextBlock)()

                If textBlock Is Nothing OrElse i = CInt(Nevron.Nov.Diagram.Shapes.ENGenogramShape.Male) OrElse i = CInt(Nevron.Nov.Diagram.Shapes.ENGenogramShape.Female) OrElse i = CInt(Nevron.Nov.Diagram.Shapes.ENGenogramShape.Pet) OrElse i = CInt(Nevron.Nov.Diagram.Shapes.ENGenogramShape.UnknownGender) Then
                    textBlock = CType(shape.TextBlock, Nevron.Nov.Diagram.NTextBlock)
                End If

                textBlock.Text = factory.GetShapeInfo(CInt((i))).Name
                ...
                Else
                    textBlock.SetFx(Nevron.Nov.Diagram.NTextBlock.PinYProperty, "$Parent.Height + Height + 10")
		...
		''' </summary>
		Public Shared ReadOnly NGenogramShapesExampleSchema As Nevron.Nov.Dom.NSchema
