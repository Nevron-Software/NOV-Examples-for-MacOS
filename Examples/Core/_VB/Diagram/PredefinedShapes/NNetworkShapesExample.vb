...
Namespace Nevron.Nov.Examples.Diagram
    Public Class NNetworkShapesExample
        ...
        ''' </summary>
		Shared Sub New()
            Nevron.Nov.Examples.Diagram.NNetworkShapesExample.NNetworkShapesExampleSchema = Nevron.Nov.Dom.NSchema.Create(GetType(Nevron.Nov.Examples.Diagram.NNetworkShapesExample), NExampleBaseSchema)
        End Sub
...
"
        ...
        Private Sub InitDiagram(ByVal drawingDocument As Nevron.Nov.Diagram.NDrawingDocument)
            ...
            ' Create all shapes
            Dim factory As Nevron.Nov.Diagram.Shapes.NNetworkShapeFactory = New Nevron.Nov.Diagram.Shapes.NNetworkShapeFactory()
        ...
        ''' </summary>
        Public Shared ReadOnly NNetworkShapesExampleSchema As Nevron.Nov.Dom.NSchema
