...
Namespace Nevron.Nov.Examples.Diagram
    Public Class NSvgExportExample
        ...
        ''' </summary>
        Shared Sub New()
            Nevron.Nov.Examples.Diagram.NSvgExportExample.NSvgExportExampleSchema = Nevron.Nov.Dom.NSchema.Create(GetType(Nevron.Nov.Examples.Diagram.NSvgExportExample), NExampleBaseSchema)
        End Sub
...
"
        ...
        ''' </summary>
        Public Shared ReadOnly NSvgExportExampleSchema As Nevron.Nov.Dom.NSchema
