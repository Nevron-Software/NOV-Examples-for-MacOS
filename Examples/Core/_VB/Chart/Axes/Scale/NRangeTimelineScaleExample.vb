...
Namespace Nevron.Nov.Examples.Chart
	...
	Public Class NRangeTimelineScaleExample
		...
		''' </summary>
		Shared Sub New()
            Nevron.Nov.Examples.Chart.NRangeTimelineScaleExample.NRangeTimelineScaleExampleSchema = Nevron.Nov.Dom.NSchema.Create(GetType(Nevron.Nov.Examples.Chart.NRangeTimelineScaleExample), NExampleBaseSchema)
        End Sub
		...
		Protected Overrides Function CreateExampleContent() As Nevron.Nov.UI.NWidget
			...
			' configure title
			chartView.Surface.Titles(CInt((0))).Text = "Range Timeline Scale"
            ...
            Me.m_RangeTimelineScale = New Nevron.Nov.Chart.NRangeTimelineScale()
            axis.Scale = Me.m_RangeTimelineScale
		...
		Private Sub OnThirdRowVisibleCheckBoxClick(ByVal arg As Nevron.Nov.Dom.NEventArgs)
            Me.m_RangeTimelineScale.FirstRow.Visible = CType(arg.TargetNode, Nevron.Nov.UI.NCheckBox).Checked
        End Sub

        Private Sub OnSecondRowVisibleCheckBoxClick(ByVal arg As Nevron.Nov.Dom.NEventArgs)
            Me.m_RangeTimelineScale.SecondRow.Visible = CType(arg.TargetNode, Nevron.Nov.UI.NCheckBox).Checked
        End Sub

        Private Sub OnFirstRowVisibleCheckBoxClick(ByVal arg As Nevron.Nov.Dom.NEventArgs)
            Me.m_RangeTimelineScale.ThirdRow.Visible = CType(arg.TargetNode, Nevron.Nov.UI.NCheckBox).Checked
        End Sub
        ...
        Private m_RangeTimelineScale As Nevron.Nov.Chart.NRangeTimelineScale

		#EndRegion

		#Region"Schema"

		Public Shared ReadOnly NRangeTimelineScaleExampleSchema As Nevron.Nov.Dom.NSchema
