...
Namespace Nevron.Nov.Examples.Chart
	...
	''' Radar area example
	''' </summary>
	Public Class NRadarAreaExample
		...
		''' </summary>
		Shared Sub New()
            Nevron.Nov.Examples.Chart.NRadarAreaExample.NRadarAreaExampleSchema = Nevron.Nov.Dom.NSchema.Create(GetType(Nevron.Nov.Examples.Chart.NRadarAreaExample), NExampleBaseSchema)
        End Sub
		...
		Protected Overrides Function CreateExampleContent() As Nevron.Nov.UI.NWidget
            Dim chartView As Nevron.Nov.Chart.NChartView = Nevron.Nov.Examples.Chart.NRadarAreaExample.CreateRadarChartView()

			' configure title
			chartView.Surface.Titles(CInt((0))).Text = "Radar Area"
            ...
            Me.m_RadarArea1.Stroke = New Nevron.Nov.Graphics.NStroke(2, Nevron.Nov.Chart.NChartTheme.BrightPalette(0))
            ...
            Me.m_RadarArea2.Stroke = New Nevron.Nov.Graphics.NStroke(2, Nevron.Nov.Chart.NChartTheme.BrightPalette(1))
...
'			axis.TitleTextStyle.TextFormat = TextFormat.XML;
		...
		Public Shared ReadOnly NRadarAreaExampleSchema As Nevron.Nov.Dom.NSchema
