...
Namespace Nevron.Nov.Examples.Chart
	...
	''' </summary>
	Public Class NStandardLineExample
		...
		''' </summary>
		Shared Sub New()
            Nevron.Nov.Examples.Chart.NStandardLineExample.NStandardLineExampleSchema = Nevron.Nov.Dom.NSchema.Create(GetType(Nevron.Nov.Examples.Chart.NStandardLineExample), NExampleBaseSchema)
        End Sub
		...
		Protected Overrides Function CreateExampleContent() As Nevron.Nov.UI.NWidget
			...
			' configure title
			chartView.Surface.Titles(CInt((0))).Text = "Standard Line"
		...
		Public Shared ReadOnly NStandardLineExampleSchema As Nevron.Nov.Dom.NSchema
