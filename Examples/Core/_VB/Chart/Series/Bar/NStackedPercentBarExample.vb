...
Namespace Nevron.Nov.Examples.Chart
	...
	Public Class NStackedPercentBarExample
		...
		''' </summary>
		Shared Sub New()
            Nevron.Nov.Examples.Chart.NStackedPercentBarExample.NStackedPercentBarExampleSchema = Nevron.Nov.Dom.NSchema.Create(GetType(Nevron.Nov.Examples.Chart.NStackedPercentBarExample), NExampleBaseSchema)
        End Sub
		...
		Protected Overrides Function CreateExampleContent() As Nevron.Nov.UI.NWidget
			...
			' configure title
			chartView.Surface.Titles(CInt((0))).Text = "Stacked Percent Bar"
            ...
            linearScale.Labels.TextProvider = New Nevron.Nov.Chart.NFormattedScaleLabelTextProvider(New Nevron.Nov.Dom.NNumericValueFormatter("P"))
            ...
            Me.m_Bar2.Name = "Bar2"
            Me.m_Bar2.MultiBarMode = Nevron.Nov.Chart.ENMultiBarMode.StackedPercent
            chart.Series.Add(Me.m_Bar2)

			' add the third bar
			Me.m_Bar3 = New Nevron.Nov.Chart.NBarSeries()
            Me.m_Bar3.Name = "Bar3"
            Me.m_Bar3.MultiBarMode = Nevron.Nov.Chart.ENMultiBarMode.StackedPercent
		...
		Public Shared ReadOnly NStackedPercentBarExampleSchema As Nevron.Nov.Dom.NSchema
