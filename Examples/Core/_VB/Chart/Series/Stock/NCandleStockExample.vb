...
Namespace Nevron.Nov.Examples.Chart
	...
	''' </summary>
	Public Class NCandleStockExample
		...
		''' </summary>
		Shared Sub New()
            Nevron.Nov.Examples.Chart.NCandleStockExample.NCandleStockExampleSchema = Nevron.Nov.Dom.NSchema.Create(GetType(Nevron.Nov.Examples.Chart.NCandleStockExample), NExampleBaseSchema)
        End Sub
		...
		Protected Overrides Function CreateExampleContent() As Nevron.Nov.UI.NWidget
			...
			' configure title
			chartView.Surface.Titles(CInt((0))).Text = "Candle Stock"
            ...
            Me.m_Stock.CandleShape = Nevron.Nov.Chart.ENCandleShape.Rectangle
        ...
        Protected Overrides Function CreateExampleControls() As Nevron.Nov.UI.NWidget
            ...
            Dim showHighLowLine As Nevron.Nov.UI.NCheckBox = New Nevron.Nov.UI.NCheckBox("Show High Low Line")
            AddHandler showHighLowLine.CheckedChanged, New Nevron.Nov.[Function](Of Nevron.Nov.Dom.NValueChangeEventArgs)(AddressOf Me.OnShowHighLowLineCheckedChanged)
		...
		Private Sub OnShowHighLowLineCheckedChanged(ByVal arg As Nevron.Nov.Dom.NValueChangeEventArgs)
            Me.m_Stock.ShowHighLow = CType(arg.TargetNode, Nevron.Nov.UI.NCheckBox).Checked
        End Sub
		...
		Public Shared ReadOnly NCandleStockExampleSchema As Nevron.Nov.Dom.NSchema
